...
const ObservationNodeComponent = ({ data }: { data: ObservationNodeProps['data'] }) => {
...
const ObservationNode = (props: ObservationNodeProps) => {
  return (
    <NodeWrapper id={props.id} type={props.type}>
      <ObservationNodeComponent data={props.data} />
    </NodeWrapper>
  );
};
